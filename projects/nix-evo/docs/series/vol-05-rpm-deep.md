...
Patch99:        evo-custom-fix.patch           # nix-evo 使用 Patch99 避免冲突
...
%changelog                                    # 变更日志
* Fri Apr 12 2026 nix-evo <evo@local> - 1.24.0-1
...
- 补丁文件用有意义的名字
- nix-evo 使用 `Patch99` 避免与现有 Patch 编号冲突
