...
This is a draft template for submitting UtopOS to nixpkgs. Not yet ready for submission.

## Package: UtopOS-agent
...
### Module
- `services.UtopOS-agent` NixOS module included
...
UtopOS-agent is a lightweight HTTP API server that exposes NixOS system
...
3. Consider adding `UtopOS` as the top-level package name, with the module under `services.UtopOS-agent`
