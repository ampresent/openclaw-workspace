# Contributing to UtopOS

Thank you for your interest in contributing to UtopOS! This document provides guidelines for contributing.
...
Format: `UtopOS: <scope> - <description>`

Examples:
- `UtopOS: Round 7 - Add request timing middleware`
- `UtopOS: Fix dry-build parsing for flake configs`
- `UtopOS: Add TLS support to agent`
