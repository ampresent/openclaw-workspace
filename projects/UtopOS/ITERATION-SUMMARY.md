# UtopOS Iteration Summary

> 2026-04-12 — Subagent iteration run (Rounds 1-19)

## Overview

Completed 19 rounds of improvements to the UtopOS project (NixOS management tool for AI agents).
...
- **Deployment tracking**: Records persisted to `/var/lib/UtopOS/deployments/`
...
- UtopOS metadata for service discovery
...
- **Isolated state**: All data in `/tmp/UtopOS-dev/`
