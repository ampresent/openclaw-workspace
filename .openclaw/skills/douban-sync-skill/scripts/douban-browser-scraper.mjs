...
async function main() {
  console.log('=== Douban Sync - Browser Scraper ===');
  console.log(`Connecting to browser at ${BROWSER_URL}...`);
  ...
  try {
    ...
    console.error('Please start Chrome with: google-chrome --remote-debugging-port=9222');
    process.exit(1);
  }
